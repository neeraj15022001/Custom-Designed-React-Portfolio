...
function CustomNavbar({colorClass}) {
  return (
    <>
      <Navbar bg="white" variant="light" expand="lg">
        <Container>
          <Navbar.Brand href="#avishka" className={`font-pacifico ${colorClass} fs-3`}>
            Avishka
          </Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" className={`${colorClass}`} />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <Nav.Link href="#home" className={`${colorClass} fw-bold`}>Home</Nav.Link>
